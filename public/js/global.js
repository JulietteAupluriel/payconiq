...
sections.forEach((section, index) => {
    ...
    ScrollTrigger.create({
        ...
        onToggle: self => setSection(section, index)
    });
...
function setSection(newSection, index) {
    ...
    document.body.className = 'sect-' + (index + 1);
    ...
    if (index == 4) {
        ...
        $('.scrollBottom').attr('href', '#sect-' + (index + 2));
        $('.scrollBottom').removeClass('top');
    }
